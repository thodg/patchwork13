...
*
  ...
  triangle.pw13p.c  -  SDL  opengl triangle patch
...
static void pw13_sdl_triangle_pump (Pw13_Patch *p, Pw13_Time *time)
{
  pw13_pump_sources (p, time);

  glBegin(GL_TRIANGLES);
  glVertex3f( 0.0f, 1.0f*pw13_float_input_val(p->input+1), 0.0f);
